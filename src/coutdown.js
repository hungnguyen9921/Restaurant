var countDate = new Date("January 22, 2018 00:00:00 ").getTime();
var countDate2 = new Date("January 07, 2019 00:00:00 ").getTime();
console.log((countDate2-countDate)/(1000*60*60*24));
